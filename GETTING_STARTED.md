...
### Exporting Logs and Traces to an OpenTelemetry collector

To export your app's logs and traces using the Embrace iOS SDK to an [OpenTelemetry collector](https://opentelemetry.io/docs/collector/) of your choice, initialize your `Embrace.Options` object with an [`OpenTelemetryExport`](./Sources/EmbraceCore/Public/OpenTelemetryExport.swift) object. 
