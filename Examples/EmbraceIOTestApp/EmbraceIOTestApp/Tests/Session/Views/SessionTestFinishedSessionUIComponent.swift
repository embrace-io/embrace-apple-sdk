...
struct SessionTestFinishedSessionUIComponent: View {
    ...
    var body: some View {
        VStack {
            Text(
                "If \"Fake App State Switch\" is OFF, you need to manually background and relaunch the app after initializing the payload test in order to start the procedure that ends a session and exports a payload."
            )
