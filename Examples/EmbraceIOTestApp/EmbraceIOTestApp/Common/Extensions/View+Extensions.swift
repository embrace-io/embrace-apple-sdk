...
extension View {
    func navigationBarModifier(backgroundColor: UIColor = .embraceLead, foregroundColor: UIColor = .embraceYellow) -> some View {
...
struct NavigationBarModifier: ViewModifier {
    init(backgroundColor: UIColor = .embraceLead, foregroundColor: UIColor = .embraceYellow){
        ...
        navBarAppearance.titleTextAttributes = [.foregroundColor: foregroundColor, .font: UIFont.systemFont(ofSize: 20, weight: .bold)]
