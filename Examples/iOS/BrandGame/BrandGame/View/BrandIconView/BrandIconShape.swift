...
struct BrandIconShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addCurve(to: CGPoint(x: 0.75589*width, y: 0.50011*height), control1: CGPoint(x: 0.70665*width, y: 0.65154*height), control2: CGPoint(x: 0.75589*width, y: 0.58374*height))
        path.addCurve(to: CGPoint(x: 0.64593*width, y: 0.34868*height), control1: CGPoint(x: 0.75589*width, y: 0.41647*height), control2: CGPoint(x: 0.70665*width, y: 0.34868*height))
        path.addCurve(to: CGPoint(x: 0.53597*width, y: 0.50011*height), control1: CGPoint(x: 0.5852*width, y: 0.34868*height), control2: CGPoint(x: 0.53597*width, y: 0.41647*height))
        path.addCurve(to: CGPoint(x: 0.64593*width, y: 0.65154*height), control1: CGPoint(x: 0.53597*width, y: 0.58374*height), control2: CGPoint(x: 0.5852*width, y: 0.65154*height))
        path.closeSubpath()

        // Left Dot
        path.move(to: CGPoint(x: 0.35423*width, y: 0.65133*height))
        path.addCurve(to: CGPoint(x: 0.4642*width, y: 0.49989*height), control1: CGPoint(x: 0.41496*width, y: 0.65133*height), control2: CGPoint(x: 0.4642*width, y: 0.58353*height))
        path.addCurve(to: CGPoint(x: 0.35423*width, y: 0.34846*height), control1: CGPoint(x: 0.4642*width, y: 0.41626*height), control2: CGPoint(x: 0.41496*width, y: 0.34846*height))
        path.addCurve(to: CGPoint(x: 0.24427*width, y: 0.49989*height), control1: CGPoint(x: 0.29351*width, y: 0.34846*height), control2: CGPoint(x: 0.24427*width, y: 0.41626*height))
        path.addCurve(to: CGPoint(x: 0.35423*width, y: 0.65133*height), control1: CGPoint(x: 0.24427*width, y: 0.58353*height), control2: CGPoint(x: 0.29351*width, y: 0.65133*height))
        path.closeSubpath()
